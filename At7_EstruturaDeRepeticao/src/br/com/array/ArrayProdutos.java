...
public class ArrayProdutos {
	...
	public static void main(String[] args) {
		...
		// O "for" vai interar do 0 até o tamanho do objeto "produtos", conseguimos ver o tamanho através do length
		// Print utilizando o método sobrecarregado "toString"
